...
const intro = [
  ...
  "その違いは「能力」や「努力量」ではありません。違いは在り方です。人は行動によって結果を作るのではなく、状態によって行動が生まれ、行動が結果を生むという順序で動いています。つまり、行動を変えても状態が変わらなければ、結果は元に戻ります。多くの男性が一時的にうまくいっても長続きしない理由はここにあります。",
  "男の魅力とは「テクニック」ではなく、存在の総合状態です。女性が感じ取っているのは言葉でも見た目でもなく、その背後にある安定、余裕、方向性、深さ、そして生き方そのものです。これらは個別に鍛えるものではなく、相互に影響し合う在り方として存在しています。",
  "これらは能力の評価ではなく、エネルギーがどこに流れているかを示す座標です。重要なのは「どこを伸ばすか」ではなく、「どこから崩れているか」を理解することです。女性関係の問題の多くは恋愛技術ではなく、この在り方の歪みから生まれます。追ってしまう、執着する、不安になる、関係が浅い、続かない。これらはすべて在り方の反映です。在り方が整うと、行動は自然に変わり、結果は後からついてきます。",
...
const elements = [
  ...
  },
  {
    ...
    key: "INSIGHT",
    ja: "洞察・理解",
    summary: "現象の裏にある在り方を見る力",
    body: "INSIGHTは「見える力」です。現象の裏にある在り方を理解する力。女性の感情、距離、反応、本音と建前。これらを個人的に受け取らず、在り方として理解できるかどうか。\n\nINSIGHTが弱いと、男性は女性の反応に振り回されます。返信速度＝好意、距離＝拒絶と解釈し、不安と追いが生まれます。INSIGHTが強いと、反応をそのまま受け取らず、距離、タイミング、状態として見ます。追うべき時と引くべき時が自然に分かります。\n\nINSIGHTは知識ではなく観察から育ちます。女性を分析するのではなく、自分の反応を観察することが重要です。感情が動いた瞬間に在り方が見えます。INSIGHTが上がると、無駄な行動が減り、関係は自然に整います。",
  },
  {
    num: "04",
    key: "DEPTH",
